...
function nuevoUsuario(nombre, email, password) {
    ...
    // Devuelve el objeto
    // Tu código:
    var objeto1 = new usuario(nombre, email, password);
    return objeto1;
...
function tieneEmail(usuario) {
    ...
    // Tu código:
    if (typeof(usuario['email']) !== 'undefined' && usuario.email !== null) { return true; } else { return false; }
}
...
function agregarMetodoCalculoDescuento(producto) {
    ...
    // Tu código:
    if (typeof(producto.calcularPrecioDescuento) === 'undefined') {
